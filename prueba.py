...
st.markdown("""
    <style>
    /* 1. ELIMINAR ESPACIO SUPERIOR TOTALMENTE Y AJUSTAR PADDING */
    ...
    h1, h2, h3 { color: #0047AB !important; font-family: 'Helvetica Neue', sans-serif; margin-top: 0 !important; margin-bottom: 0.2rem !important; } 
    .slogan-text { color: #5F6368; font-size: 1.2rem; font-style: italic; margin-bottom: 2rem; text-align: center; }
