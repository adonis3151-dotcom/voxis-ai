    ...
    if not st.session_state.otp_sent:
        ...
        if st.secrets.get("GOOGLE_CLIENT_ID", ""):
            ...
            st.markdown(
                ...
                f' {t.get("btn_google", "Continuar con Google")}</a>',
                unsafe_allow_html=True
            )
