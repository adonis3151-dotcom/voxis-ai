...
footer {visibility: hidden;}
    ...
    div[data-testid="stMetricValue"] { color: #FF7F50; font-weight: bold; }
...
# --- FUNCIÓN DE ENVÍO DE CORREOS (NUEVA) ---
...
if st.session_state.usuario_db is None:
    if os.path.exists("logo.png"): st.image("logo.png", width=150) # Ajustado tamaño del logo un poco más pequeño
...
# --- PANTALLA 4: DASHBOARD PRINCIPAL ---
    ...
    with col_logo:
        if os.path.exists("logo.png"): st.image("logo.png", width=50) # Ajustado tamaño del logo un poco más pequeño
